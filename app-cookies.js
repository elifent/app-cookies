 ...
 *
 * Add app-cookies to code as below
 * <app-cookies id="elementId" key="cookieKey"></app-cookies>
 * 
 * To set app cookies use
 * this.$.elementId.set('new value');
 * 
 * To unset value of cookie use
 ...
 * @polymer
 */
class AppCookies extends PolymerElement {
  ...
  ready(){
    ...
    this.data = cookiejs.get(this.key);
  }
